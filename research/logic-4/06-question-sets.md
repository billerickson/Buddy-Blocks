...
choices:
  ...
  - "Does the conclusion follow from a truth table?"
  - "Is the statement a question?"
  - "Can the word water be negated?"
...
```question
key: u04_l04_q04_error_correction_overclaim
type: error-correction
prompt: "Correct the overclaim so it does not claim proven cause."
sentence: "Students who ate breakfast scored higher, so breakfast definitely caused the higher scores."
acceptedAnswers:
  - "Students who ate breakfast scored higher, so breakfast was related to higher scores."
  - "Students who ate breakfast scored higher, but this does not prove breakfast caused the higher scores."
  - "Students who ate breakfast scored higher, so more evidence is needed to show cause."
explanation: "A correlation or pattern does not by itself prove causation."
hint: "Replace definite cause language with related-to or needs-more-evidence language."
...
choices:
  ...
  - "Any final answer that can never change"
...
choices:
  ...
  - "Claim: Trash exists; Reason: Bottles are bottles; Evidence: Reusable means true"
  - "Claim: The class is a truth table; Reason: Bottles are premises; Evidence: none"
...
choices:
  ...
  - "Reasons that have the same first letter"
  - "Reasons that cannot support anything"
  - "Reasons that are always false"
...
choices:
  ...
  - "No student owns a bike."
  - "Bike racks are a kind of truth table."
...
choices:
  ...
  - "The club should meet because it should meet."
  - "Before has six letters."
...
choices:
  ...
  - "Homework clubs are good because they are good."
  - "Your objection does not matter."
  - "Buses are vehicles."
