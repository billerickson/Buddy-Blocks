---
id: lesson_grade11_vocabulary_argument_structure_argument_structure_preview
slug: argument-structure-preview
title: Argument Structure Preview
xpBase: 5
config:
  intro:
    - title: Read Before Recall
      body: Meet the argument structure words in context before using flash cards.
      bullets:
