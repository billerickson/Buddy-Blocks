---
id: lesson_grade3_literature_u04_l01_a_quest_has_a_goal
...
Teach quest structure as more than travel: a goal, path, obstacle, and meaningful outcome.

## Student Outcome

The student can identify the goal and main parts of a short quest or journey episode.

## Misconception Checks

Any trip is a quest; the obstacle alone is the point; the goal can be ignored once action begins.
