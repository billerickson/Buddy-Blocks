---
id: lesson_grade3_literature_u01_l01_retell_the_fable_in_order
...
Teach students to retell a compact fable as a sequence of important events rather than as isolated favorite details.

## Student Outcome

The student can place the beginning, middle, and end of a fable in order and include the key event that makes the ending make sense.

## Misconception Checks

Retelling only the ending; adding events not in the story; confusing a minor detail with a key event.

## Teaching Note

Read a short fable aloud once for enjoyment, then reread and mark what happened first, what changed, and how it ended.
