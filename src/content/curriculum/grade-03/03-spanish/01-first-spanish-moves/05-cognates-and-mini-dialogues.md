---
id: lesson_grade3_spanish_u01_l05_cognates_and_mini_dialogues
...
Teach students to use cognates and context to understand short Spanish exchanges while staying alert for false certainty.

## Student Outcome

The student can identify helpful cognates, avoid overtrusting them, and build a short polite dialogue from familiar chunks.

## Misconception Checks

Assuming every look-alike word has the exact English meaning; reading for isolated words instead of the whole exchange; choosing dialogue lines by word similarity alone.

## Teaching Note

Show a tiny dialogue containing one or two cognates and ask what students can understand before translating.
