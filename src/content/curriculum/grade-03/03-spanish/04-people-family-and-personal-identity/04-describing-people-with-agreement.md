---
id: lesson_grade3_spanish_u04_l04_describing_people_with_agreement
...
Extend adjective agreement from objects to people descriptions.

## Student Outcome

The student can describe people with familiar adjectives that agree in gender and number when applicable.

## Misconception Checks

Using masculine singular as a default for everyone; changing adjectives like `inteligente` to forms that are not used; placing adjectives before nouns by English habit.

## Teaching Note

Compare `mi hermano`, `mi hermana`, and `mis amigos` with the same adjective idea.
