---
id: lesson_grade3_spanish_u06_l06_novice_capstone_presentation
...
Guide students to combine learned language into a compact self, family, school, likes, food, place, and routine presentation.

## Student Outcome

The student can interpret a model capstone and produce a short supported presentation using accurate familiar chunks.

## Misconception Checks

Trying to use unsupported advanced grammar; valuing length over accuracy; omitting key learned domains; translating an English paragraph word by word.

## Teaching Note

Show a model capstone with sentence jobs labeled: greeting, name/age, family, school, like, food/place, routine, closing.
