---
id: lesson_grade3_french_u07_l03_simple_routines_with_familiar_chunks
...
Students describe a simple daily routine using known present-tense chunks and time-of-day phrases.

## Student Outcome

The student can order and produce short routine statements with le matin, l'après-midi, le soir, je vais, je fais, j'aime, je mange, and je bois as formulaic exposure.

## Misconception Checks

Treating the routine as a past-tense story; changing every verb form without a model; writing disconnected word lists instead of short statements.

## Teaching Note

Present routines as "today/general habit" chunks, not a full tense lesson.
