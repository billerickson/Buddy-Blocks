---
id: lesson_grade3_french_u07_l04_french_1_capstone_exchange
...
Students recombine familiar French 1 language in a compact mixed novice task.

## Student Outcome

The student can interpret a short familiar text, choose appropriate dialogue replies, and produce a brief self or everyday profile.

## Misconception Checks

Translating word by word instead of using known chunks; ignoring question words; forgetting earlier article or negation patterns when topics are mixed; trying to write beyond novice control.

## Teaching Note

Remind students to hunt for familiar clues: greeting, question word, article, number, verb chunk, and context.
