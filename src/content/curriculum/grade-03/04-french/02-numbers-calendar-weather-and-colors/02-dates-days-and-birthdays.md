---
id: lesson_grade3_french_u02_l02_dates_days_and_birthdays
...
Students use days, months, dates, and birthdays in short routine statements.

## Student Outcome

The student can interpret and complete phrases such as aujourd'hui c'est lundi, la date est le 5 mai, and mon anniversaire est en juin.

## Misconception Checks

Translating English date order directly; using a month without en when the phrase requires it; confusing day and month words.

## Teaching Note

Start from today's date card and point to each part: day, number, month.
