---
id: lesson_grade3_french_u03_l03_question_words_that_shape_answers
...
Students use question words to predict the kind of answer needed.

## Student Outcome

The student can identify whether comment, qui, où, d'où, quel/quelle, or pourquoi calls for name, person, place, origin, age/date, or reason.

## Misconception Checks

Answering by picking a familiar phrase without reading the question word; confusing où and d'où; treating pourquoi as a yes/no question.

## Teaching Note

Model a "listen for the first clue" routine: question word first, then familiar words.
