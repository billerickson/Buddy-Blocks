---
id: lesson_grade3_french_u06_l02_il_y_a_and_where_things_are
...
Students distinguish existence with il y a from location with est plus a preposition.

## Student Outcome

The student can describe what is in a classroom or bag and where a familiar object is located.

## Misconception Checks

Using il y a for every location; ignoring the preposition; treating sur, sous, and dans as interchangeable.

## Teaching Note

Ask two different questions: "What is there?" and "Where is it?" Keep the answers visibly different.
