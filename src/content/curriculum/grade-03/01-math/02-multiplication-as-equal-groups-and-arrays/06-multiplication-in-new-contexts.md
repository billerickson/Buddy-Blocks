---
id: lesson_grade3_math_u02_l08_multiplication_in_new_contexts
slug: multiplication-in-new-contexts
title: Multiplication In New Contexts
xpBase: 10
---

## Teaching Goal

Apply equal-group multiplication reasoning in unfamiliar but controlled contexts.

## Student Outcome

The student can recognize multiplication structure in new situations and solve using a model or equation.

## Key Ideas

Multiplication can model any situation with equal groups, not only classroom arrays.

## Misconceptions

Relying on surface words instead of equal groups; using addition when equal groups could be structured; overlooking unequal groups.
