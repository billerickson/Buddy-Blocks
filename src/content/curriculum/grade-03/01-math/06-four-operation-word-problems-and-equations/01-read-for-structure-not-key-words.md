---
id: lesson_grade3_math_u06_l01_read_for_structure_not_key_words
...
Shift students from key-word hunting to identifying the mathematical relationship in a situation.

## Student Outcome

The student can explain whether a story involves joining, separating, comparing, equal groups, sharing, or grouping.
...
"More" always means add; "left" always means subtract; all equal-group stories use the same operation.

## Teaching Note

Present two stories using the word "more," one addition and one comparison, and discuss the relationship.
