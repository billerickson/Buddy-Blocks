---
id: lesson_grade3_math_u01_l08_choose_a_model_and_check
slug: choose-a-model-and-check
title: Choose A Model And Check
xpBase: 10
---

## Teaching Goal

Establish the habit of choosing a useful representation and checking whether the answer makes sense.

## Student Outcome

The student can select a number line, strip diagram, equation, or array for a simple problem and explain the choice.

## Key Ideas

Different models reveal different structures; checking connects the answer back to the situation.

## Misconception Checks

Using the most recent model for every problem; drawing without connecting to quantities; checking only means recalculating quickly.

## Teaching Note

Show the same problem with two possible models and discuss which one makes the relationship clearer.
