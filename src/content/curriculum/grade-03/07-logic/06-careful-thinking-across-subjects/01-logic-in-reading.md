---
id: lesson_grade3_logic_u06_l01_logic_in_reading
...
Apply claim, evidence, and conclusion routines to a short reading passage.

## Student Outcome

The student can identify a passage-supported claim or conclusion and choose relevant text evidence.
...
Choosing a sentence because it is interesting; using outside knowledge instead of passage evidence; repeating the claim as evidence.

## Teaching Note

Model reading the question first, then hunting for the sentence that actually supports the answer.
