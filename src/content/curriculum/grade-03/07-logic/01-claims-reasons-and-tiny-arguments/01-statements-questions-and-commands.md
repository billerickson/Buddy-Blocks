---
id: lesson_grade3_logic_u01_l01_statements_questions_and_commands
...
Help students sort common sentence jobs before they analyze arguments.

## Student Outcome

The student can distinguish statements, questions, commands, and exclamations in familiar contexts.

## Key Ideas

A sentence's job can be identified by what it does: tells, asks, directs, or shows strong feeling.

## Misconception Checks

Treating every sentence as a statement; relying only on punctuation; confusing commands with questions when both mention an action.

## Teaching Note

Show four sentences about the same topic, such as a book, and ask what each one is trying to do.
