---
id: lesson_grade3_logic_u02_l01_reasons_examples_and_evidence
...
Distinguish common support types students will meet in short arguments.

## Student Outcome

The student can tell whether a support sentence is a reason, an example, or evidence.

## Key Ideas

Reasons explain why, examples show one case, and evidence gives information that can support a claim.

## Misconception Checks

Calling every support sentence evidence; treating examples and reasons as identical; thinking evidence must always be a number.

## Teaching Note

Use one claim about a class garden and compare a reason, an example, and a simple observation.
