---
id: lesson_grade3_logic_u04_l01_if_then_rules
slug: if-then-rules
title: If-Then Rules
xpBase: 10
config:
...
Identify the condition and result in simple if-then rules.

## Student Outcome

The student can label what must happen first and what follows in an if-then rule.
...
Treating both parts as equal statements; missing the condition; reversing if and then.

## Teaching Note

Use "If the light is red, then cars stop" and mark the two parts.
