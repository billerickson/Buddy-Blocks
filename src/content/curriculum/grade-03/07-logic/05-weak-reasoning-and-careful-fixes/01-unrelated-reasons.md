---
id: lesson_grade3_logic_u05_l01_unrelated_reasons
...
Recognize a reason that does not support the claim.

## Student Outcome

The student can identify unrelated reasons and choose a reason that fits better.

## Key Ideas

A reason can sound positive or true but still fail to answer why the claim should be accepted.

## Misconception Checks

Any positive detail supports a positive claim; sharing a topic is enough; more enthusiasm means stronger reasoning.

## Teaching Note

Reuse a familiar claim and show one fitting reason beside one unrelated true detail.
