---
id: lesson_grade3_vocabulary_u04_l05_check_word_parts_with_context
slug: check-word-parts-with-context
title: Check Word Parts With Context
xpBase: 10
---

## Teaching Goal

Teach students to test morphology guesses against sentence meaning and reject false word-part clues.

## Student Outcome

The student can decide when a word-part clue helps and when context shows the guess is wrong or incomplete.

## Misconception Checks

Trusting a word part even when the sentence disagrees; splitting words into false parts; using the prefix meaning but ignoring the base.

## Teaching Note

Compare a helpful word such as `reread` with a false split such as `corner` not meaning `corn + er`.
