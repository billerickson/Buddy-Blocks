---
id: lesson_grade4_latin_roman_daily_life_public_spaces_translation_practice
...
questions:
  - type: multiple-choice
    ...
    choices:
      ...
      - toga
    correctAnswer: shop
    explanation: taberna means shop.
  - type: text-input
    prompt: Type the Latin for "toga".
    acceptedAnswers:
      - toga
    answerType: text
  ...
  - type: constructed-response
    ...
    minWords: 3
    sampleAnswer: A natural translation uses clues from civis in foro ambulat.
    checklist:
      - Use English meaning
