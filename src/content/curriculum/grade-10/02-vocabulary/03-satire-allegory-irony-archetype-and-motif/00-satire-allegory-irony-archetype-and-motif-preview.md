---
id: lesson_grade10_vocabulary_satire_allegory_irony_archetype_and_motif_satire_allegory_irony_archetype_and_motif_preview
slug: satire-allegory-irony-archetype-and-motif-preview
title: Satire, Allegory, Irony, Archetype, And Motif Preview
xpBase: 5
config:
  intro:
    - title: Read Before Recall
      body: Meet the satire, allegory, irony, archetype, and motif words in context before using flash cards.
      bullets:
...
questions:
  - type: passage-question
    ...
    passageTitle: Satire, Allegory, Irony, Archetype, And Motif Study Page
    passage: 'Satire, Allegory, Irony, Archetype, And Motif study page: The word "context" means the words and ideas around an unfamiliar word. The word "category" means a group of things that belong together. The word "attribute" means a quality or feature used to describe something. The word "synonym" means a word with a similar meaning. The word "antonym" means a word with the opposite meaning. The word "precise" means exact and carefully chosen. The word "compound" means a word made from two smaller words. The word "prefix" means a word part added to the beginning. Students read the page, talked about examples, and then practiced retrieval.'
