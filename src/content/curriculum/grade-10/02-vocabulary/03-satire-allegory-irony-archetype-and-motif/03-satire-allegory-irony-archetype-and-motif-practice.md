---
id: lesson_grade10_vocabulary_satire_allegory_irony_archetype_and_motif_satire_allegory_irony_archetype_and_motif_practice
slug: satire-allegory-irony-archetype-and-motif-practice
title: Satire, Allegory, Irony, Archetype, And Motif Practice
xpBase: 10
config:
  intro:
    - title: Satire, Allegory, Irony, Archetype, And Motif
...
questions:
  ...
  - type: fill-blank
    ...
    explanation: The clue gives the meaning of "category".
  - type: match-pairs
    prompt: Match the satire, allegory, irony, archetype, and motif words to meanings.
    pairs:
      - left: attribute
  ...
  - type: passage-question
    ...
    passageTitle: Satire, Allegory, Irony, Archetype, And Motif In Use
    passage: During discussion, Noor chose the word "compound" because it means a word made from two smaller words. Then she used "prefix" to make her explanation more exact.
    question: Which word in the paragraph means "a word made from two smaller words"?
    choices:
      - compound
      - prefix
      - context
  ...
  - type: text-input
    prompt: Type the word that means "a word part added to the beginning".
    acceptedAnswers:
      - prefix
    answerType: text
    explanation: The word is "prefix".
  - type: multiple-choice
