---
id: lesson_grade6_math_u02_l01_what_a_ratio_compares
...
Introduce ratios as comparisons between two quantities.

## Student Outcome

The student can identify the two quantities in a ratio and describe the comparison in words.
...
A ratio is just one number; the order of quantities does not matter; totals alone define the ratio.

## Teaching Note

Use a simple two-color tile set and say the relationship in several equivalent verbal forms.
