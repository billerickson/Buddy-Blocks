---
id: lesson_grade6_math_u07_l01_equations_as_balanced_statements
...
Reinforce equality as a relationship between two expressions.

## Student Outcome

The student can decide whether an equation is true for a value and explain what equality means.
...
The equals sign means "compute next"; the expression on the left is always the problem; balance is visual only.

## Teaching Note

Compare `8 + 5 = 13` with `13 = 8 + 5` and `8 + 5 = 6 + 7`.
