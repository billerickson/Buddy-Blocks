---
id: lesson_grade6_math_u03_l01_rate_language_and_units
...
Interpret rates by attending to both quantities and their units.

## Student Outcome

The student can explain what statements such as "60 miles per hour" or "$4 per pound" mean.

## Key Ideas

A rate compares quantities with different units, and "per" tells which quantity is tied to one unit.

## Misconception Checks

Per language is decorative; unit order does not matter; a rate is the same as a total.

## Teaching Note

Contrast "30 miles in 2 hours" with "15 miles per hour."
