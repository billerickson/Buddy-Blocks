---
id: lesson_grade6_math_u01_l01_estimate_before_you_calculate
...
Establish estimation as a planning and checking tool for Grade 6 computations.

## Student Outcome

The student can choose benchmark or compatible numbers and predict a reasonable answer range before exact calculation.

## Key Ideas

Number-line benchmarks and rounded quantities show the likely size of a sum, product, difference, or quotient.

## Misconception Checks

Estimation is guessing; exact answers are always needed; estimates should be made only after calculating.

## Teaching Note

Compare an exact computation with a quick estimate and ask how the estimate can catch an impossible answer.
