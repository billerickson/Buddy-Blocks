---
id: lesson_grade6_math_u09_l01_statistical_questions_and_variability
...
The student can decide whether a question anticipates variability in data and revise a nonstatistical question when appropriate.

## Key Ideas

A statistical question expects answers that vary across people, objects, or repeated measurements.

## Misconception Checks

Any question with a number is statistical; one-person questions are always statistical; variability means error.

## Teaching Note

Compare "How tall is Maya?" with "How tall are students in our class?"
