---
id: lesson_grade6_math_u05_l01_positive_and_negative_contexts
...
Give signed numbers meaning as positions or changes relative to a reference point.

## Student Outcome

The student can match positive and negative numbers to contexts such as elevation, temperature, debt, or game score.
...
Negative means bad in every context; the sign can be dropped; zero is always "nothing" rather than a reference.

## Teaching Note

Compare 5 degrees above zero and 5 degrees below zero on a vertical number line.
