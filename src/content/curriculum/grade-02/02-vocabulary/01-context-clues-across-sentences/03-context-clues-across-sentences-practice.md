---
id: lesson_grade2_vocabulary_context_clues_across_sentences_context_clues_across_sentences_practice
slug: context-clues-across-sentences-practice
title: Context Clues Across Sentences Practice
xpBase: 10
config:
  intro:
    - title: Context Clues Across Sentences
...
questions:
  ...
  - type: fill-blank
    ...
    explanation: The clue gives the meaning of "explain".
  - type: match-pairs
    prompt: Match the context clues across sentences words to meanings.
    pairs:
      - left: context
  ...
  - type: passage-question
    ...
    passageTitle: Context Clues Across Sentences In Use
