---
id: lesson_grade2_vocabulary_multiple_meaning_words_and_homophones_multiple_meaning_words_and_homophones_practice
slug: multiple-meaning-words-and-homophones-practice
title: Multiple-Meaning Words And Homophones Practice
xpBase: 10
config:
  intro:
    - title: Multiple-Meaning Words And Homophones
...
questions:
  ...
  - type: fill-blank
    ...
    explanation: The clue gives the meaning of "synonym".
  - type: match-pairs
    prompt: Match the multiple-meaning words and homophones words to meanings.
    pairs:
      - left: antonym
  ...
  - type: passage-question
    ...
    passageTitle: Multiple-Meaning Words And Homophones In Use
    passage: During discussion, Noor chose the word "suffix" because it means a word part added to the end. Then she used "base word" to make her explanation more exact.
    question: Which word in the paragraph means "a word part added to the end"?
    choices:
      - suffix
      - base word
      - attribute
  ...
  - type: text-input
    prompt: Type the word that means "the main word that can take prefixes or suffixes".
    acceptedAnswers:
      - base word
    answerType: text
    explanation: The word is "base word".
  - type: multiple-choice
