---
id: lesson_grade2_vocabulary_synonyms_antonyms_shades_and_precision_synonyms_antonyms_shades_and_precision_practice
slug: synonyms-antonyms-shades-and-precision-practice
title: Synonyms, Antonyms, Shades, And Precision Practice
xpBase: 10
config:
  intro:
    - title: Synonyms, Antonyms, Shades, And Precision
...
questions:
  ...
  - type: fill-blank
    ...
    explanation: The clue gives the meaning of "attribute".
  - type: match-pairs
    prompt: Match the synonyms, antonyms, shades, and precision words to meanings.
    pairs:
      - left: synonym
  ...
  - type: passage-question
    ...
    passageTitle: Synonyms, Antonyms, Shades, And Precision In Use
    passage: During discussion, Noor chose the word "prefix" because it means a word part added to the beginning. Then she used "suffix" to make her explanation more exact.
    question: Which word in the paragraph means "a word part added to the beginning"?
    choices:
      - prefix
      - suffix
      - category
  ...
  - type: text-input
    prompt: Type the word that means "a word part added to the end".
    acceptedAnswers:
      - suffix
    answerType: text
    explanation: The word is "suffix".
  - type: multiple-choice
